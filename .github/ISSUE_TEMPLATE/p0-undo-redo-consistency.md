...
- 在 store 内部确保撤销/重做走同一份 ProjectDocument（参见 [ADR-004](../../docs/decisions/ADR-004-Document-Model.md)）。
...
- 文档：[WeSVG-开发文档.md §9 历史记录](../../docs/WeSVG-开发文档.md)
